#!/usr/bin/env node
// Decides whether vendor/agent-harness should be repinned, given the tag the
// submodule is on now and the latest agent-harness release tag. The answer is
...
// The semver.org reference grammar, with the `v` prefix the harness tags carry.
const RELEASE_TAG =
